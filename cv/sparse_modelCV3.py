...
top_model.load_weights('/nfs/home/pgulyaev/diploma/cv/bottleneck_fc_modelCV3.h5')
...
all_shock_inputs = get_inputs(whole_shock_dir+class1Name+'/'+class1Name+'*.jpg')
shock_inputs = all_shock_inputs[2000:2500]
shock_inputs.extend(all_shock_inputs[0:500])
#nonshock_inputs = get_inputs(whole_nonshock_dir+class2Name+'/'+class2Name+'*')[3090:5150]
# nonshock_inputs.extend(get_inputs(border_data_dir+class2Name+'/*')[60:100])
...
model.fit(train_activations.values, train_activations.values, 
          ...
          batch_size=20, nb_epoch=250)

model.save_weights('sparseWeightsCV3.h5')
