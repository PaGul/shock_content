...
top_model.load_weights('/nfs/home/pgulyaev/diploma/cv/bottleneck_fc_modelCV5.h5')
...
shock_inputs = get_inputs(whole_shock_dir+class1Name+'/'+class1Name+'*.jpg')[500:1500]
...
model.save_weights('sparseWeightsCV5.h5')
