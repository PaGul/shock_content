...
top_model.load_weights('/nfs/home/pgulyaev/diploma/cv/bottleneck_fc_modelCV2.h5')
...
im_inputs = get_inputs(whole_shock_dir+class1Name+'/'+class1Name+'*')[0:500]
im_inputs.extend(get_inputs(whole_nonshock_dir+class2Name+'/'+class2Name+'*')[3090:5150])
im_inputs.extend(get_inputs(border_data_dir+class2Name+'/*')[60:100])
print(len(im_inputs))
test_activations = get_activations(new_model, im_inputs, RELEVANT_LAYER_NAME)
test_activations.to_csv('activations/testCV2.csv')
