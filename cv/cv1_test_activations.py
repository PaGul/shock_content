...
im_inputs = get_inputs(whole_shock_dir+class1Name+'/'+class1Name+'*')[2000:2500]
im_inputs.extend(get_inputs(whole_nonshock_dir+class2Name+'/'+class2Name+'*')[2060:4120])
...
test_activations.to_csv('activations/testCV1.csv')
