...
top_model.load_weights('/nfs/home/pgulyaev/diploma/cv/bottleneck_fc_modelCV4.h5')
...
shock_inputs = get_inputs(whole_shock_dir+class1Name+'/'+class1Name+'*.jpg')[0:1000]
...
model.save_weights('sparseWeightsCV4.h5')
